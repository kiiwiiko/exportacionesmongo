...
@PageTitle("Lista Importacion")
@Route(value = "lista-importacion", layout = MainLayout.class)
@Uses(Icon.class)
public class ListaImportacionView extends Composite<VerticalLayout> {

    public ListaImportacionView() {
        H2 h2 = new H2();
